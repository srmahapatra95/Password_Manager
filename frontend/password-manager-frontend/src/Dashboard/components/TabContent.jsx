    ...
    return (
        ...
        <div className="w-full p-2 h-full flex flex-col relative">
            <div className="w-full h-9/10 flex flex-col justify-center p-2">
                ...
                <div className="">
                    ...
                    <div className="flex flex-row absolute top-0 right-0">
                        <button onClick={handleDecryptPassword} className="flex flex-row items-center justify-start cursor-pointer p-2 mx-1 text-slate-100 rounded-md hover:bg-slate-500">
                        ...
                        className=" cursor-pointer p-2 text-slate-100 rounded-md  hover:bg-slate-500">
                            Change
                        </button>
                    </div>
            ...
            <div className="w-full h-1/10 flex flex-row justify-end p-2">
                <button onClick={handleSave} className="cursor-pointer flex flex-row justify-between items-center p-2 border-2 border-white mx-1 text-slate-100 rounded-md hover:bg-slate-500">
