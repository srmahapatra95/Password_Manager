...
function Screen(){
    ...
    return (
        <div className="absolute top-0 left-0 bg-gray-200 dark:bg-gray-900 w-screen h-screen flex flex-col">
            <button id="close-screen-btn" onClick={handleCloseScreen} className=" w-4 h-4 m-2 text-black dark:text-white hover:bg-rose-800 hover:text-white dark:hover:text-black rounded-full cursor-pointer">
