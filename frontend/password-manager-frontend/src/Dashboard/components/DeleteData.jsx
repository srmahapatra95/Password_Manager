    ...
    function ListItem({data}){
        ...
        function handleItemCheck(itemId) {
            setCheckState(prevState => ({
                ...
                return(
                    <div className="w-40 text-wrap p-2 flex flex-row items-center justify-start rounded-md">
                        ...
                        />
                            ...
                            <div className="mx-2 text-slate-100 p-1">
        ...
        <div className='w-full p-2 overflow-y-auto no-scrollbar'>
            ...
            <div className="absolute right-5 bottom-2 cursor-pointer text-slate-100 hover:bg-gray-700"> 
            <div  onClick={handleDeleteData} className="cursor-pointer w-full flex flex-row items-center p-3 w-20 border-2 border-rose-800 text-rose-500 hover:bg-rose-700 hover:text-slate-100 rounded-md">
