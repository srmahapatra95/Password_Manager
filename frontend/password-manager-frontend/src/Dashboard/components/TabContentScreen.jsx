...
function TabContentScreen({chooseTabContentScreen, setChooseTabContentScreen}){
    ...
    return (
        <> 
        <div className=" text-white absolute w-full h-full bg-black bg-opacity-10">
            <div className="w-full p-2 flex flex-row justify-end bg-indigo-600">
                <button onClick={handleCloseScreen} className="text-white hover:bg-rose-50 rounded-full">
            ...
            <div className="w-full h-95/100 flex flex-col items-center justify-center">
                ...
                <button onClick={handleTokenSubmit} className="text-white border-2 border-slate-300 w-8/10 h-10 cursor-pointer my-2 hover:bg-slate-300">Submit</button>
            </div>
            </>):(<>
            <div className="w-full h-95/100 flex flex-col items-center justify-center ">
                <label className="text-white text-3xl my-2" >Enter the Profile Password</label>
                <input className="text-white border-2 border-slate-300 w-8/10 h-10 indent-2 my-2" type="password"/>
                <button onClick={handleProfilePasswordSubmit} className="text-white border-2 border-slate-300 w-8/10 h-10 cursor-pointer my-2 hover:bg-slate-300">Submit</button>
            </div>  
            </>)}
